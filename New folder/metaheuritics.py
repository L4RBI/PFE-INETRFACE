...
class metaheuristics:
    ...
    def bat(self, N, GEN, bmin=0, bmax=255, fmin=0, fmax=0.2, intiR=0.5, initA=0.95,  alpha=0.9, gamma=0.9):
        toolbox = base.Toolbox()
        toolbox.register("bat", BAT.generate, m=self.m, bmin=bmin, bmax=bmax,
                         histogram=self.histogram, size=self.size, init_R=initR, init_A=initA)
